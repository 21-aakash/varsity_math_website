        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
          ...
          <div className="md:pl-8 px-4 sm:px-0">
            ...
            <div className="space-y-4 sm:space-y-6 text-gray-700 leading-relaxed text-sm sm:text-base">
              <p>
                At <span className="text-blue-600 font-semibold">Varsity Math</span>, our journey began with a simple mission – to make strong conceptual understanding accessible to every student.
              </p>
